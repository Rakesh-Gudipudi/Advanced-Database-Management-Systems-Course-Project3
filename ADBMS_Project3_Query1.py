...
# Fetching records of age < 21
def first_query(result, count):
    for i in result:
        if calculate_age(i.day, i.month, i.year) < 21:
            print("Block- Number", count, "SSN-", i.ssn,"First Name-", i.fname, "Last Name-", i.lname)


# Calculating age of each record
def calculate_age(dd, mm, yyyy):
